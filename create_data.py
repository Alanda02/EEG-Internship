...
for subject in list(CONFIG["subjects"]):
    ...
    for exp_type in CONFIG["experiments"]:
        ...
        cal_name = "AndresLandaverde.Internship2020.FirstTask.edf"
        exp_name = "AndresLandaverde.Internship2020.SecondTask.edf"
...
#NEEEEEEEEEEEEEEEEEEWWWWWWWW

        print('RESULTS')

        print('First')
        for subband in eyes_sub_bands:
            mean_value = np.mean(eyes_sub_bands.get(subband))
            print(subband)
            print(mean_value)

        print('Second')
        for sub in experiment_sub_bands:
            mean = np.mean(experiment_sub_bands.get(sub))
            print(sub)
            print(mean)
